    ...
    with st.container():
        st.markdown("""
            <div class='large'>
                ...
                <img src='images/efh.webp' alt='Construction worker using digital tablet'>
                <p>Ich bin ein Fan von dieser Plattform die den Austausch und die Beschaffung von Second 
                Hand Bauteilen erleichtert!!! Über die Integration mit Speckle kann ich mein digitales Modell 
                direkt auf die Plattform hochladen. Dieser Schritt ist entscheidend, denn dadurch wird automatisch 
                eine Abgleichung aller Bauteile meines Modells mit dem verfügbaren Angebot auf der Plattform 
                durchgeführt. Die Plattform präsentiert mir umgehend alle verfügbaren Bauteile, die den 
                spezifischen Anforderungen meines digitalen Zwillings entsprechen. Diese präzise Übereinstimmung 
                ermöglicht es mir, schnell die passenden Bauteile zu identifizieren. Ich kann diese Bauteile direkt 
                über die Plattform reservieren. Wichtig dabei ist, dass nicht nur die Geometrie der Bauteile, 
                sondern auch die zugehörigen Attribute, die das Bauteil definieren, nahtlos in meine Autorensoftware 
                geladen werden. Dies erfolgt wiederum über die Speckle-Schnittstelle. Durch diesen einfachen und 
                automatisierten Workflow wird der gesamte Planungsprozess erheblich erleichtert. Die Möglichkeit, 
                spezifische Anforderungen direkt mit dem Angebot abzugleichen und die benötigten Bauteile effizient 
                in die Planungssoftware zu integrieren, spart Zeit und fördert die Verwendung von nachhaltigen 
                Materialien. Dieser Ansatz unterstützt nicht nur eine umweltfreundliche Bauweise, sondern optimiert 
                auch die Kosten- und Ressourceneffizienz meines Projekts.</p>
    ...
    with st.container():
        st.markdown("""
               <div class='large'>
                   ...
                   <img src='images/efh.webp' alt='Construction worker using digital tablet'>
                   <p>Als Bauherr in der strategischen Planungsphase eines Neubaus steht für mich Nachhaltigkeit 
                   im Vordergrund. Um diesem Anspruch gerecht zu werden, nutze ich eine besondere Funktion unserer 
                   Plattform: die Lokalisierung potenzieller Second Hand Bauteile in meiner direkten Umgebung. Durch 
                   die Eingabe meines Standorts in die Plattform kann ich sofort alle relevanten Bauwerke einsehen, 
                   ...
                   Ich lade alle Interessierten ein, sich mit mir über die Möglichkeiten auszutauschen und unsere 
                   Ressourcen zu bündeln, um unsere Bauvorhaben nachhaltiger und effizienter zu gestalten. Vielen 
                   Dank für Ihre Aufmerksamkeit und Ihr Engagement für eine grünere Bauwelt.</p>
    ...
    with st.container():
        st.markdown("""
            <div class='large'>
                ...
                <img src='images/efh.webp' alt='Construction worker using digital tablet'>
                <p>Liebe Handwerker-Gemeinschaft, als Handwerker arbeite ich eng mit Planern und Bauherren 
                zusammen, um die Nachhaltigkeit und Effizienz unserer Bauprojekte zu maximieren. Ein wesentlicher 
                ...
                nachhaltig und präzise zu arbeiten, und empfehle jedem Handwerker, diesen Ansatz zu verfolgen. 
                Lasst uns gemeinsam die Vorteile der digitalen Vernetzung nutzen und unsere Bauprojekte 
                effizienter und umweltfreundlicher gestalten!</p>
